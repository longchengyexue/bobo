...
<div id="body3">
  <div id="body3_body0">
    <div id="body3_title"><a href="base_add"><img src="<%=basePath %>index/images/add_add.jpg" border="0" /></a></div>
	<div id="body3_text">
	 <div id="body3_text_policy">
	 <ul>
		<s:iterator value="list" var="vo">
		<li>
		<span id="body3_text_policy_con"><a href="singleread.action?bid=<s:property value='#vo.bid'/>"><s:property value="#vo.bname"/></a></span>
		<span id="body3_text_policy_date"><s:property value="#vo.bdate"/></span>
		<span style="float:left; width:90px;">
			<a href="4Export_update.action?bid=<s:property value='#vo.bid'/>">
				<img src="<%=basePath %>manager/images/edit.jpg" border="0" />
			</a>
		</span>
		<span style="float:left; width:90px">
			<a href="base_delete.action?bid=<s:property value='#vo.bid'/>">
	 ...
	 <div id="body3_text_policy_page"><form id="main_pageform" action="2ExportBase.action" method="post">
			<ul class="tails">
				<li><a href = "2ExportBase.action?info.currentPage=1">首页</a></li>
				<li><a href = "2ExportBase.action?info.currentPage=<s:property value='info.currentPage'/>&info.pageType=back">上一页</a></li>
				<li>第<s:property value="info.currentPage"/>页</li>
				<li><a href = "2ExportBase.action?info.currentPage=<s:property value='info.currentPage'/>&info.pageType=next">下一页</a></li>
				<li><a href = "2ExportBase.action?info.currentPage=<s:property value='info.maxPage'/>">尾页</a></li>	
