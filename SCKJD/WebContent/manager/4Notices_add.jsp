...
<div id="body3">
  <div id="body3_body0">
	...
	<s:form name="myForm" action="manageradd.action" method="post">
	   <ul>
	     <li><span class="14boldblack" style="float:left;"><font size="2"><b>标题：</b></font></span>
          <span style="float:left;"><input id="ev.ntitle" name="ev.ntitle" type="text" style="width:350px; height:20px;" /></span></li>
		 <li><span class="14boldblack" style="float:left;"><font size="2"><b>日期：</b></font></span>
	      <span style="float:left;" ><input type="text" id="ev.ndate"  name="ev.ndate" style="width:150px; height:20px;"   readOnly onClick="setDay(this);"></span></li>
		 <li><span class="14boldblack" style="float:left;"><font size="2"><b>内容：</b></font></span>
	      <span style="float:left;"><textarea id="ev.ncontent" name="ev.ncontent" cols="" rows="10" style="width:350px; height:auto;"></textarea></span></li>
		 <li style="padding:0px 100px;">
		 	<span style="float:left; margin:10px;">
				<img src="<%=basePath %>manager/images/ok.jpg" border="0" onclick="return gcheck();"/>
			</span>
		 	<span style="float:left;  margin:10px;">
				<img src="<%=basePath %>manager/images/reset.jpg" border="0" onclick="return reset3();"/>
			</span>
		</li>
	   </ul>
	</s:form>
