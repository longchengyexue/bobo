...
<div id="body3">
  <div id="body3_body0">
    <div id="body3_title2"><a href="manager4Notices.action"><img src="<%=basePath %>manager/images/add_add.jpg" border="0" /></a></div>
	<div id="body3_text">
	 ...
	 <ul>
		...
		<span id="body3_text_policy_con">
				<a href="manager3Notices.action?nid=<s:property value="#ev.nid"/>">
				<s:property value="#ev.ntitle"/>
				</a>
		</span>
		<span id="body3_text_policy_date"><s:property value="#ev.ndate"/></span>

		<span style="float:left; width:90px;"><a href="update.action?nid=<s:property value="#ev.nid"/>"><img src="<%=basePath %>manager/images/edit.jpg" border="0" /></a></span>

		<span style="float:left; width:90px"><a href="date.action?nid=<s:property value="#ev.nid"/>"><img src="<%=basePath %>manager/images/del.jpg" border="0" /></a></span>
		</li>
		</s:iterator>
	...
	<div id="body3_text_policy_page">
		<form id="main_pageform" action="managerNotices.action" method="post">
			<ul class="tails">
				<li><a href = "managerNotices.action?info.currentPage=1">首页</a></li>
				<li><a href = "managerNotices.action?info.currentPage=<s:property value='info.currentPage'/>&info.pageType=back">上一页</a></li>
				<li>第<s:property value="info.currentPage"/>页</li>
				<li><a href = "managerNotices.action?info.currentPage=<s:property value='info.currentPage'/>&info.pageType=next">下一页</a></li>
				<li><a href = "managerNotices.action?info.currentPage=<s:property value='info.maxPage'/>">尾页</a></li>	
