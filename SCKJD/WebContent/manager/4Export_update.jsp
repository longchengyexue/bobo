...
<div id="body3">
  <div id="body3_body0">
    <div id="body3_title"></div>
	<div id="body3_text">
	 <div id="body3_text_product_issue">
	<s:form name="myForm" action="2submit_return.action" method="post">
	   <ul>
		 ...
		 <li><span class="14boldblack" style="float:left;"><font size="2"><b>基地地址：</b></font></span>
	      ...
	      <!--<span style="float:left;"><input id="vo.bimagepath" name="vo.bimagepath" type="text" style="width:150px; height:20px;" value="<s:property value='%{vo.bimagepath}'/>"/></span></li> -->
		 ...
		 <li style="padding:0px 100px;"><span style="float:left; margin:10px;"><img src="<%=basePath %>manager/images/ok.jpg" border="0" onClick="return jcheck();"/></span><span style="float:left;  margin:10px;"><img src="<%=basePath %>manager/images/reset.jpg" border="0" onClick="return qreset();"/></span></li>
	   </ul>
		 <input id="vo.bid" name="vo.bid" type="hidden" value="<s:property value='%{vo.bid}'/>"/> 
	</s:form>
	 </div>
	</div>
  </div>
